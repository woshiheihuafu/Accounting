...
| SCREEN-ACCOUNTING-V2-002 | 首页-年月选择弹窗 | REQ-ACCOUNTING-001, REQ-ACCOUNTING-006 | DESIGN-ACCOUNTING-002 | draft | 40% 遮罩，纸白面板圆角 16px，确定按钮鼠尾草绿；不可选未来月（设计稿滚轮为示意，实际禁止未来，intake INTAKE-002） |
...
| SCREEN-ACCOUNTING-V2-006 | 记账-日期选择弹窗 | REQ-ACCOUNTING-005, REQ-ACCOUNTING-006 | DESIGN-ACCOUNTING-002 | draft | 三列滚轮，样式同年月选择器；不可选未来日期（设计稿滚轮为示意，实际禁止未来，intake INTAKE-002） |

## 流程索引

| FLOW ID | 流程 | 关联页面 | 关联 REQ | 状态 | 备注 |
| --- | --- | --- | --- | --- | --- |
| FLOW-ACCOUNTING-V2-001 | 首页查看与切换年月 | SCREEN-ACCOUNTING-V2-001, SCREEN-ACCOUNTING-V2-002 | REQ-ACCOUNTING-001, REQ-ACCOUNTING-006 | draft | 月份 36px 居左点击触发，确定按钮鼠尾草绿；年月不可选未来（CHANGE-ACCOUNTING-001） |
| FLOW-ACCOUNTING-V2-002 | 支出记账 | SCREEN-ACCOUNTING-V2-003, SCREEN-ACCOUNTING-V2-005, SCREEN-ACCOUNTING-V2-006 | REQ-ACCOUNTING-003, REQ-ACCOUNTING-005, REQ-ACCOUNTING-006 | draft | 支出保存为负金额；账单日期不可选未来、初始默认今天（CHANGE-ACCOUNTING-001） |
| FLOW-ACCOUNTING-V2-003 | 收入记账 | SCREEN-ACCOUNTING-V2-004, SCREEN-ACCOUNTING-V2-005, SCREEN-ACCOUNTING-V2-006 | REQ-ACCOUNTING-004, REQ-ACCOUNTING-005, REQ-ACCOUNTING-006 | draft | 收入保存为正金额；账单日期不可选未来、初始默认今天（CHANGE-ACCOUNTING-001） |
